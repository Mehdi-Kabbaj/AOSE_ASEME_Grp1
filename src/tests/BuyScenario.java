...
/*
 * Scenario where we check that a consumer over two producers , chose the best offer and make a reservation
 */
public class BuyScenario {
	public static void main(String[] args) throws InterruptedException {
		...
		try{
            ...
            System.out.println(o2a_co.getChosenOffer().toString());
            if(o2a_co.getChosenOffer().toString().equals("Offer [price=50.0, producer=Producer1, renewable=true]")){
            	System.out.println("BUY SCENARIO WITH TWO PRODUCERS AND ONE CONSUMER SUCCESS, END OF THE TEST");
            	o2a_mp.doDelete();
            	o2a_pa1.doDelete();
            	o2a_pa2.doDelete();
            	o2a_co.doDelete();
